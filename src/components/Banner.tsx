    ...
    >
      ...
      >
        ...
        <span className="text-textDark mt-2 lgl:mt-4">
          This is my website personal portfolio.
        </span>
      </motion.h1>
      ...
      <motion.button className="w-52 h-14 text-sm font-titleFont border border-textGreen rounded-md text-textGreen tracking-wide hover:bg-hoverColor duration-300">
